import { RELEASES, KIND_META, CURRENT_VERSION, REPO_URL } from './releaseNotesData.js';
...
const STORAGE_KEY = 'hood:lastSeenReleaseVersion';
...
let query = '';
const openVersions = new Set([RELEASES[0].version]);
