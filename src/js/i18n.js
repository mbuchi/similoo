...
const translations = {
  en: {
    ...
    'comparison.pool_fallback': 'Few recent building permits in this window, so these comparables come from the parcel register.',
  ...
  fr: {
    ...
    'comparison.pool_fallback': 'Peu de permis de construire récents dans cette fenêtre, ces comparables proviennent donc du registre des parcelles.',
    ...
    'help.filter_year_body':
      'Seuls les bâtiments construits dans la fenêtre d\'années comptent - 10 ans par défaut. Le curseur de la barre latérale déplace la fenêtre par pas d\'un an, de 1 à 10 ans, pour suivre un changement récent du plan de zones ou du droit de la construction : réglez-le sur le nombre d\'années écoulées depuis l\'entrée en vigueur de la règle et seuls les bâtiments achevés sous ce régime restent. La resserrer fait apparaître moins de comparables, plus récents.',
  ...
  de: {
    ...
    'comparison.pool_fallback': 'Wenige neue Baubewilligungen in diesem Fenster, diese Vergleichsobjekte stammen daher aus dem Parzellenregister.',
    ...
    'help.filter_year_body':
      'Nur Gebäude, die innerhalb des Jahresfensters gebaut wurden, zählen - standardmässig 10 Jahre. Der Schieberegler in der Seitenleiste verschiebt das Fenster in Ein-Jahres-Schritten von 1 bis 10 Jahren und kann so einer jüngeren Änderung der Zonenordnung oder des Baurechts folgen: Stellen Sie ihn auf die Jahre seit Inkrafttreten der Regel, und nur die darunter fertiggestellten Gebäude bleiben übrig. Ein engeres Fenster zeigt weniger, neuere Vergleichsobjekte.',
  ...
  it: {
    ...
    'comparison.pool_fallback': 'Pochi permessi di costruzione recenti in questa finestra, quindi questi comparabili provengono dal registro delle particelle.',
    ...
    'help.filter_year_body':
      'Contano solo gli edifici costruiti entro la finestra di anni - 10 anni per impostazione predefinita. Il cursore nella barra laterale sposta la finestra a passi di un anno, da 1 a 10 anni, così da seguire una modifica recente del piano delle zone o del diritto edilizio: impostalo sugli anni trascorsi dall\'entrata in vigore della norma e restano solo gli edifici completati sotto di essa. Restringendola emergono comparabili meno numerosi e più recenti.',
