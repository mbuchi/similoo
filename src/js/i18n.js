...
const translations = {
  en: {
    ...
    'comparison.years_all': 'All',
    'comparison.years_all_aria': 'All years, no construction-year limit',
    'comparison.years_step_aria': 'Last {years} years',
    ...
    'help.filter_year_body':
      'Only buildings built within the years window count - 10 years by default. The sidebar offers a ladder of fixed steps: 5, 10, 15, 20, 40, 60 years, or All, which drops the construction-year limit entirely. Widening it surfaces more, older comparables.',
  ...
  fr: {
    ...
    'comparison.years_all': 'Tout',
    'comparison.years_all_aria': 'Toutes les années, sans limite d\'année de construction',
    'comparison.years_step_aria': '{years} dernières années',
    ...
    'help.filter_year_body':
      'Seuls les bâtiments construits dans la fenêtre d\'années comptent - 10 ans par défaut. La barre latérale propose des paliers fixes : 5, 10, 15, 20, 40, 60 ans ou Tout, qui supprime entièrement la limite d\'année de construction. L\'élargir fait apparaître davantage de comparables, plus anciens.',
  ...
  de: {
    ...
    'comparison.years_all': 'Alle',
    'comparison.years_all_aria': 'Alle Jahre, keine Baujahrsgrenze',
    'comparison.years_step_aria': 'Letzte {years} Jahre',
    ...
    'help.filter_year_body':
      'Nur Gebäude, die innerhalb des Jahresfensters gebaut wurden, zählen - standardmässig 10 Jahre. Die Seitenleiste bietet feste Stufen: 5, 10, 15, 20, 40, 60 Jahre oder Alle, womit die Baujahrsgrenze ganz entfällt. Ein grösseres Fenster bringt mehr, ältere Vergleichsobjekte hervor.',
  ...
  it: {
    ...
    'comparison.years_all': 'Tutti',
    'comparison.years_all_aria': 'Tutti gli anni, nessun limite di anno di costruzione',
    'comparison.years_step_aria': 'Ultimi {years} anni',
    ...
    'help.filter_year_body':
      'Contano solo gli edifici costruiti entro la finestra di anni - 10 anni per impostazione predefinita. La barra laterale offre gradini fissi: 5, 10, 15, 20, 40, 60 anni oppure Tutti, che elimina del tutto il limite di anno di costruzione. Allargandola emergono comparabili più numerosi e più datati.',
