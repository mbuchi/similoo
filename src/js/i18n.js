...
const translations = {
  ...
  de: {
    ...
    'help.filter_year_body':
      'Nur Gebäude, die jünger sind als das maximale Baualter, zählen - standardmässig 10 Jahre. Der Schieberegler in der Seitenleiste bewegt sich in Ein-Jahres-Schritten von 1 bis 10 Jahren und kann so einer jüngeren Änderung der Zonenordnung oder des Baurechts folgen: Stellen Sie ihn auf die Jahre seit Inkrafttreten der Regel, und nur die darunter fertiggestellten Gebäude bleiben übrig. Ein engeres Fenster zeigt weniger, neuere Vergleichsobjekte. In Zonen, in denen zuletzt kaum gebaut wurde, bleiben nur wenige Treffer oder gar keine - deshalb hat der Regler eine Stufe hinter 10 Jahren: «Jedes Alter» hebt die Baujahr-Grenze auf und vergleicht mit der ganzen Zone.',
  ...
  it: {
    ...
    'help.filter_year_body':
      'Contano solo gli edifici più recenti dell\'età massima - 10 anni per impostazione predefinita. Il cursore nella barra laterale si sposta a passi di un anno, da 1 a 10 anni, così da seguire una modifica recente del piano delle zone o del diritto edilizio: impostalo sugli anni trascorsi dall\'entrata in vigore della norma e restano solo gli edifici completati sotto di essa. Restringendolo emergono comparabili meno numerosi e più recenti. Nelle zone in cui si è costruito poco di recente restano pochi risultati o nessuno: per questo il cursore ha uno scatto oltre i 10 anni - «Qualsiasi età» - che elimina il limite sull\'anno di costruzione e confronta con tutta la zona.',
