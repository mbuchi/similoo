...
const translations = {
  en: {
    ...
    'nav.settings_coming_soon': 'Coming soon',
    'nav.locate_me': 'Locate me',
    'menu.more_tools': 'More tools',
    'menu.saved_parcels': 'My saved parcels',
    'menu.active': 'Active',
    'menu.user': 'User',
    'about.menu': 'About',
    'about.description': 'similoo finds buildings comparable to a Swiss address - same municipality and zone, recent construction - and shows them as LOD 2.5 cubes plus a detailed 3D inspection.',
    'about.label': 'About similoo',
    ...
    'meta.description':
      'Find buildings comparable to your parcel - same zoning, recent construction - visualized in 3D in the same municipality.',
    ...
    'meta.twitter_description':
      'Find buildings comparable to your parcel in the same municipality.',
    ...
    'nav.search_loading': 'Searching addresses…',
    'nav.search_no_results': 'No matches',
    'nav.clear_search': 'Clear search',
    'nav.search_results_count': '{count} address suggestions available',
    ...
    // Panel topic tabs (PANEL_TABS_STANDARD.md). similoo owns "Compare", its
    // headline subject; the "Build" label is canonical and comes from
    // @aireon/shared/panel-topics, so it is deliberately NOT in this table.
    'comparison.topic_compare': 'Compare',
    'comparison.topic_selector': 'Parcel topics',
    'comparison.build_empty': 'No parcel outline here, so there is nothing to simulate.',
    ...
    'comparison.track': 'Track',
    'comparison.tracked': 'Tracked',
    'comparison.track_saving': 'Saving…',
    'comparison.track_unsaving': 'Removing…',
    'comparison.track_sign_in': 'Sign in to track',
    'comparison.track_error': 'Try again',
    'comparison.track_title': 'Track this parcel',
    'comparison.untrack_title': 'Stop tracking this parcel',
    'comparison.section_parcel': 'Parcel',
    'comparison.section_building': 'Building',
    ...
    'comparison.metric_height_short': 'Height',
    'comparison.metric_floors': 'Floors',
    'comparison.metric_floors_short': 'Floors',
    'comparison.metric_year': 'Built',
    'comparison.metric_ratiov': 'ratioV',
    'comparison.metric_similarity_short': 'Match',
    'comparison.metric_achievable': 'Achievable volume (allowed gross floor area × 3 m)',
    'comparison.metric_achievable_short': 'Achievable',
    'comparison.metric_utilization': 'Utilization (gross floor area ÷ parcel area)',
    'comparison.metric_utilization_short': 'Util.',
    'comparison.filters_title': 'Filters',
    'comparison.max_building_age': 'Max building age',
    'comparison.years_value_one': '1 year',
    'comparison.years_value_other': '{years} years',
    'comparison.years_value_all': 'Any age',
    'comparison.years_valuetext_one': 'Built in the last year',
    'comparison.years_valuetext_other': 'Built in the last {years} years',
    'comparison.years_valuetext_all': 'Any construction year',
    'comparison.years_scale_all': 'Any',
    ...
    'comparison.sort_achievable': 'By achievable volume',
    'comparison.sort_utilization': 'By utilization',
    'comparison.pager_aria': 'Comparables pages',
    'comparison.pager_prev': 'Previous page',
    'comparison.pager_next': 'Next page',
    'comparison.pager_range': '{from}–{to} of {total}',
    'comparison.status_loading': 'Loading comparables…',
    'comparison.status_empty': 'No comparable buildings for this parcel yet. Try raising the max building age, up to "Any age".',
    'comparison.status_error': 'Could not load comparables. Try again later.',
    'comparison.card_aria': 'Comparable parcel {egrid}',
    'comparison.card_show_hint': 'Show on map',
    'comparison.card_view_pointcloud': 'Open 3D point cloud',
    'comparison.popup_close': 'Close',
    'comparison.popup_open_geopool': 'Open parcel in geopool',
    ...
    'landing.subtitle': 'similoo finds buildings comparable to the one at this address - same municipality and zone, recent construction - and shows them as LOD 2.5 cubes on the map plus a detailed 3D inspection on demand.',
    ...
    'legend.same_zone': 'Parcels of the same municipal zone type',
    'legend.comparable': 'Comparable buildings',

    // ---------- building detail popup ----------
    'detail.close': 'Close 3D detail',
    'detail.color_elevation': 'Elevation',
    'detail.color_classification': 'Classification',
    'detail.color_intensity': 'Intensity',
    'detail.preparing': 'Preparing point cloud… {percent}%',
    ...
    'help.intro':
      'When you search an address, similoo looks for buildings that are genuine peers of the one on your parcel - same municipality and planning zone, similar age, similar density - then ranks them by how closely they match. Here is exactly how that works.',
    ...
    'help.filter_year_title': 'Building age',
    'help.filter_year_body':
      'Only buildings younger than the max building age count - 10 years by default. The sidebar slider moves one year at a time from 1 to 10, so it can follow a recent zoning or building-law change: set it to the years since the rule took effect and only buildings completed under it remain. Narrowing it surfaces fewer, newer comparables. Zones where little has been built lately can leave you with a handful of matches or none at all, so the slider widens past 10 in three more steps - 15 years, 20 years, and "Any age", which drops the construction-year limit and compares against the whole zone.',
    ...
    'help.step3_note':
      'The closer a candidate\'s parcel size, ratioV and age are to the target, the higher its match. Cards are sorted by similarity by default, but you can re-sort them by ratioV, parcel size, year, achievable volume or utilization, six cards to a page.',
  ...
  fr: {
    ...
    'panel.zoom.in': 'Zoom avant',
    'panel.zoom.out': 'Zoom arrière',
    'panel.zoom.reset_north': 'Réorienter au nord',
    'nav.settings': 'Paramètres',
    'nav.settings_coming_soon': 'Bientôt disponible',
    'nav.locate_me': 'Me localiser',
    'menu.more_tools': 'Plus d’outils',
    'menu.saved_parcels': 'Mes parcelles enregistrées',
    'menu.active': 'Actif',
    'menu.user': 'Utilisateur',
    'about.menu': 'À propos',
    'about.description': 'similoo trouve des bâtiments comparables à une adresse suisse - même commune et même zone, construction récente - et les affiche en cubes LOD 2.5 avec une inspection 3D détaillée.',
    'about.label': 'À propos de similoo',
    ...
    'meta.description':
      'Trouvez des bâtiments comparables à votre parcelle - même zonage, construction récente - visualisés en 3D dans la même commune.',
    ...
    'meta.twitter_description':
      'Trouvez des bâtiments comparables à votre parcelle dans la même commune.',
    ...
    'nav.search_loading': 'Recherche d’adresses…',
    'nav.search_no_results': 'Aucun résultat',
    'nav.clear_search': 'Effacer la recherche',
    'nav.search_results_count': '{count} suggestions d’adresses disponibles',
    ...
    'comparison.topic_compare': 'Comparer',
    'comparison.topic_selector': 'Thèmes de la parcelle',
    'comparison.build_empty': 'Aucun contour de parcelle ici, rien à simuler.',
    ...
    'comparison.copy': 'Copier',
    'comparison.track': 'Suivre',
    'comparison.tracked': 'Suivi',
    'comparison.track_saving': 'Enregistrement…',
    'comparison.track_unsaving': 'Suppression…',
    'comparison.track_sign_in': 'Connectez-vous pour suivre',
    'comparison.track_error': 'Réessayer',
    'comparison.track_title': 'Suivre cette parcelle',
    'comparison.untrack_title': 'Ne plus suivre cette parcelle',
    'comparison.section_parcel': 'Parcelle',
    'comparison.section_building': 'Bâtiment',
    ...
    'comparison.metric_height_short': 'Hauteur',
    'comparison.metric_floors': 'Étages',
    'comparison.metric_floors_short': 'Étages',
    'comparison.metric_year': 'Construit',
    'comparison.metric_ratiov': 'ratioV',
    'comparison.metric_similarity_short': 'Sim.',
    'comparison.metric_achievable': 'Volume réalisable (surface de plancher admissible × 3 m)',
    'comparison.metric_achievable_short': 'Réalisable',
    'comparison.metric_utilization': 'Utilisation (surface de plancher ÷ surface de parcelle)',
    'comparison.metric_utilization_short': 'Util.',
    'comparison.filters_title': 'Filtres',
    'comparison.max_building_age': 'Ancienneté max.',
    'comparison.years_value_one': '1 an',
    'comparison.years_value_other': '{years} ans',
    'comparison.years_value_all': 'Tout âge',
    'comparison.years_valuetext_one': 'Construit au cours de la dernière année',
    'comparison.years_valuetext_other': 'Construit au cours des {years} dernières années',
    'comparison.years_valuetext_all': 'N\'importe quelle année de construction',
    'comparison.years_scale_all': 'Tout',
    ...
    'comparison.sort_achievable': 'Par volume réalisable',
    'comparison.sort_utilization': 'Par utilisation',
    'comparison.pager_aria': 'Pages des comparables',
    'comparison.pager_prev': 'Page précédente',
    'comparison.pager_next': 'Page suivante',
    'comparison.pager_range': '{from}–{to} sur {total}',
    'comparison.status_loading': 'Chargement des comparables…',
    'comparison.status_empty': 'Aucun bâtiment comparable pour cette parcelle. Essayez d\'augmenter l\'ancienneté max., jusqu\'à « Tout âge ».',
    ...
    'comparison.card_show_hint': 'Afficher sur la carte',
    'comparison.card_view_pointcloud': 'Ouvrir le nuage de points 3D',
    'comparison.popup_close': 'Fermer',
    'comparison.popup_open_geopool': 'Ouvrir la parcelle dans geopool',
    ...
    'landing.subtitle': 'similoo trouve des bâtiments comparables à celui de cette adresse - même commune et même zone, construction récente - et les affiche en cubes LOD 2.5 sur la carte, avec une inspection 3D détaillée à la demande.',
    ...
    'legend.same_zone': 'Parcelles du même type de zone communale',
    'legend.comparable': 'Bâtiments comparables',

    'detail.close': 'Fermer la vue 3D détaillée',
    'detail.color_elevation': 'Altitude',
    'detail.color_classification': 'Classification',
    'detail.color_intensity': 'Intensité',
    'detail.preparing': 'Préparation du nuage de points… {percent}%',
    ...
    'help.intro':
      'Lorsque vous recherchez une adresse, similoo cherche des bâtiments réellement comparables à celui de votre parcelle - même commune, même zone d\'affectation, âge similaire, densité similaire - puis les classe selon leur degré de correspondance. Voici exactement comment cela fonctionne.',
    ...
    'help.filter_year_title': 'Ancienneté du bâtiment',
    'help.filter_year_body':
      'Seuls les bâtiments plus récents que l\'ancienneté maximale comptent - 10 ans par défaut. Le curseur de la barre latérale se déplace par pas d\'un an, de 1 à 10 ans, pour suivre un changement récent du plan de zones ou du droit de la construction : réglez-le sur le nombre d\'années écoulées depuis l\'entrée en vigueur de la règle et seuls les bâtiments achevés sous ce régime restent. Le resserrer fait apparaître moins de comparables, plus récents. Dans les zones où l\'on a peu construit récemment, il ne reste qu\'une poignée de correspondances, voire aucune : le curseur s\'élargit donc au-delà de 10 ans en trois crans supplémentaires - 15 ans, 20 ans, puis « Tout âge », qui supprime la limite d\'année de construction et compare avec toute la zone.',
    ...
    'help.step3_note':
      'Plus la surface de parcelle, le ratioV et l\'âge d\'un candidat sont proches de la cible, plus sa correspondance est élevée. Les cartes sont triées par similarité par défaut, mais vous pouvez les retrier par ratioV, surface de parcelle, année, volume réalisable ou utilisation, six cartes par page.',
  ...
  de: {
    ...
    'panel.zoom.reset_north': 'Nach Norden ausrichten',
    'nav.settings': 'Einstellungen',
    'nav.settings_coming_soon': 'Demnächst verfügbar',
    'nav.locate_me': 'Mich lokalisieren',
    'menu.more_tools': 'Weitere Tools',
    'menu.saved_parcels': 'Meine gespeicherten Parzellen',
    'menu.active': 'Aktiv',
    'menu.user': 'Benutzer',
    'about.menu': 'Über',
    'about.description': 'similoo findet Gebäude, die mit einer Schweizer Adresse vergleichbar sind - gleiche Gemeinde und Zone, neuer Bau - und zeigt sie als LOD-2.5-Würfel sowie eine detaillierte 3D-Ansicht.',
    'about.label': 'Über similoo',
    ...
    'meta.description':
      'Finden Sie Gebäude, die mit Ihrer Parzelle vergleichbar sind - gleiche Zonierung, neuere Bauten - in 3D in derselben Gemeinde visualisiert.',
    ...
    'meta.twitter_description':
      'Finden Sie Gebäude, die mit Ihrer Parzelle in derselben Gemeinde vergleichbar sind.',
    ...
    'nav.search_loading': 'Adressen werden gesucht…',
    'nav.search_no_results': 'Keine Treffer',
    'nav.clear_search': 'Suche löschen',
    'nav.search_results_count': '{count} Adressvorschläge verfügbar',
    ...
    'comparison.topic_compare': 'Vergleichen',
    'comparison.topic_selector': 'Parzellenthemen',
    'comparison.build_empty': 'Kein Parzellenumriss vorhanden, es gibt nichts zu simulieren.',
    ...
    'comparison.copy': 'Kopieren',
    'comparison.track': 'Verfolgen',
    'comparison.tracked': 'Verfolgt',
    'comparison.track_saving': 'Speichern…',
    'comparison.track_unsaving': 'Entfernen…',
    'comparison.track_sign_in': 'Zum Verfolgen anmelden',
    'comparison.track_error': 'Erneut versuchen',
    'comparison.track_title': 'Diese Parzelle verfolgen',
    'comparison.untrack_title': 'Diese Parzelle nicht mehr verfolgen',
    'comparison.section_parcel': 'Parzelle',
    'comparison.section_building': 'Gebäude',
    ...
    'comparison.metric_height_short': 'Höhe',
    'comparison.metric_floors': 'Geschosse',
    'comparison.metric_floors_short': 'Gesch.',
    'comparison.metric_year': 'Baujahr',
    'comparison.metric_ratiov': 'ratioV',
    'comparison.metric_similarity_short': 'Sim.',
    'comparison.metric_achievable': 'Realisierbares Volumen (zulässige Geschossfläche × 3 m)',
    'comparison.metric_achievable_short': 'Realisierbar',
    'comparison.metric_utilization': 'Ausnützung (Geschossfläche ÷ Parzellenfläche)',
    'comparison.metric_utilization_short': 'Ausn.',
    'comparison.filters_title': 'Filter',
    'comparison.max_building_age': 'Max. Baualter',
    'comparison.years_value_one': '1 Jahr',
    'comparison.years_value_other': '{years} Jahre',
    'comparison.years_value_all': 'Jedes Alter',
    'comparison.years_valuetext_one': 'Im letzten Jahr gebaut',
    'comparison.years_valuetext_other': 'In den letzten {years} Jahren gebaut',
    'comparison.years_valuetext_all': 'Beliebiges Baujahr',
    'comparison.years_scale_all': 'Alle',
    ...
    'comparison.sort_achievable': 'Nach realisierbarem Volumen',
    'comparison.sort_utilization': 'Nach Ausnützung',
    'comparison.pager_aria': 'Seiten der Vergleichbaren',
    'comparison.pager_prev': 'Vorherige Seite',
    'comparison.pager_next': 'Nächste Seite',
    'comparison.pager_range': '{from}–{to} von {total}',
    'comparison.status_loading': 'Vergleichbare werden geladen…',
    'comparison.status_empty': 'Noch keine vergleichbaren Gebäude für diese Parzelle. Erhöhen Sie das max. Baualter, bis «Jedes Alter».',
    ...
    'comparison.card_show_hint': 'Auf Karte anzeigen',
    'comparison.card_view_pointcloud': '3D-Punktwolke öffnen',
    'comparison.popup_close': 'Schliessen',
    'comparison.popup_open_geopool': 'Parzelle in geopool öffnen',
    ...
    'landing.subtitle': 'similoo findet Gebäude, die mit dem an dieser Adresse vergleichbar sind - gleiche Gemeinde und Zone, kürzlich gebaut - und zeigt sie als LOD-2.5-Würfel auf der Karte plus eine detaillierte 3D-Ansicht auf Wunsch.',
    ...
    'legend.same_zone': 'Parzellen desselben kommunalen Zonentyps',
    'legend.comparable': 'Vergleichbare Gebäude',

    'detail.close': '3D-Detailansicht schliessen',
    'detail.color_elevation': 'Höhe',
    'detail.color_classification': 'Klassifikation',
    'detail.color_intensity': 'Intensität',
    'detail.preparing': 'Punktwolke wird vorbereitet… {percent}%',
    ...
    'help.intro':
      'Wenn Sie eine Adresse suchen, sucht similoo nach Gebäuden, die echte Pendants zu dem auf Ihrer Parzelle sind - gleiche Gemeinde und Nutzungszone, ähnliches Alter, ähnliche Dichte - und reiht sie danach, wie genau sie übereinstimmen. So funktioniert das genau.',
    ...
    'help.filter_year_title': 'Baualter',
    'help.filter_year_body':
      'Nur Gebäude, die jünger sind als das maximale Baualter, zählen - standardmässig 10 Jahre. Der Schieberegler in der Seitenleiste bewegt sich in Ein-Jahres-Schritten von 1 bis 10 Jahren und kann so einer jüngeren Änderung der Zonenordnung oder des Baurechts folgen: Stellen Sie ihn auf die Jahre seit Inkrafttreten der Regel, und nur die darunter fertiggestellten Gebäude bleiben übrig. Ein engeres Fenster zeigt weniger, neuere Vergleichsobjekte. In Zonen, in denen zuletzt kaum gebaut wurde, bleiben nur wenige Treffer oder gar keine - deshalb öffnet sich der Regler hinter 10 Jahren in drei weiteren Stufen: 15 Jahre, 20 Jahre und «Jedes Alter», das die Baujahr-Grenze aufhebt und mit der ganzen Zone vergleicht.',
    ...
    'help.step3_note':
      'Je näher Parzellenfläche, ratioV und Alter eines Kandidaten am Ziel liegen, desto höher seine Übereinstimmung. Die Karten sind standardmässig nach Ähnlichkeit sortiert, lassen sich aber nach ratioV, Parzellenfläche, Baujahr, realisierbarem Volumen oder Ausnützung neu sortieren, sechs Karten pro Seite.',
  ...
  it: {
    ...
    'panel.zoom.reset_north': 'Orienta a nord',
    'nav.settings': 'Impostazioni',
    'nav.settings_coming_soon': 'Prossimamente',
    'nav.locate_me': 'Localizzami',
    'menu.more_tools': 'Altri strumenti',
    'menu.saved_parcels': 'Le mie particelle salvate',
    'menu.active': 'Attivo',
    'menu.user': 'Utente',
    'about.menu': 'Informazioni',
    'about.description': 'similoo trova edifici comparabili a un indirizzo svizzero - stesso comune e stessa zona, costruzione recente - e li mostra come cubi LOD 2.5 con un’ispezione 3D dettagliata.',
    'about.label': 'Informazioni su similoo',
    ...
    'meta.description':
      'Trova edifici comparabili alla tua particella - stessa zona, costruzione recente - visualizzati in 3D nello stesso comune.',
    ...
    'meta.twitter_description':
      'Trova edifici comparabili alla tua particella nello stesso comune.',
    ...
    'nav.search_loading': 'Ricerca indirizzi…',
    'nav.search_no_results': 'Nessun risultato',
    'nav.clear_search': 'Cancella ricerca',
    'nav.search_results_count': '{count} suggerimenti di indirizzo disponibili',
    ...
    'comparison.topic_compare': 'Confrontare',
    'comparison.topic_selector': 'Argomenti particella',
    'comparison.build_empty': 'Nessun contorno di particella qui, niente da simulare.',
    ...
    'comparison.copy': 'Copia',
    'comparison.track': 'Segui',
    'comparison.tracked': 'Seguito',
    'comparison.track_saving': 'Salvataggio…',
    'comparison.track_unsaving': 'Rimozione…',
    'comparison.track_sign_in': 'Accedi per seguire',
    'comparison.track_error': 'Riprova',
    'comparison.track_title': 'Segui questa particella',
    'comparison.untrack_title': 'Smetti di seguire questa particella',
    'comparison.section_parcel': 'Particella',
    'comparison.section_building': 'Edificio',
    ...
    'comparison.metric_height_short': 'Altezza',
    'comparison.metric_floors': 'Piani',
    'comparison.metric_floors_short': 'Piani',
    'comparison.metric_year': 'Anno',
    'comparison.metric_ratiov': 'ratioV',
    'comparison.metric_similarity_short': 'Sim.',
    'comparison.metric_achievable': 'Volume realizzabile (superficie lorda ammessa × 3 m)',
    'comparison.metric_achievable_short': 'Realizzabile',
    'comparison.metric_utilization': 'Sfruttamento (superficie lorda ÷ superficie particella)',
    'comparison.metric_utilization_short': 'Sfrutt.',
    'comparison.filters_title': 'Filtri',
    'comparison.max_building_age': 'Età max.',
    'comparison.years_value_one': '1 anno',
    'comparison.years_value_other': '{years} anni',
    'comparison.years_value_all': 'Qualsiasi età',
    'comparison.years_valuetext_one': 'Costruito nell\'ultimo anno',
    'comparison.years_valuetext_other': 'Costruito negli ultimi {years} anni',
    'comparison.years_valuetext_all': 'Qualsiasi anno di costruzione',
    'comparison.years_scale_all': 'Tutti',
    ...
    'comparison.sort_achievable': 'Per volume realizzabile',
    'comparison.sort_utilization': 'Per sfruttamento',
    'comparison.pager_aria': 'Pagine dei comparabili',
    'comparison.pager_prev': 'Pagina precedente',
    'comparison.pager_next': 'Pagina successiva',
    'comparison.pager_range': '{from}–{to} di {total}',
    'comparison.status_loading': 'Caricamento comparabili…',
    'comparison.status_empty': 'Nessun edificio comparabile per questa particella. Aumentare l\'età max., fino a «Qualsiasi età».',
    ...
    'comparison.card_show_hint': 'Mostra sulla mappa',
    'comparison.card_view_pointcloud': 'Apri nuvola di punti 3D',
    'comparison.popup_close': 'Chiudi',
    'comparison.popup_open_geopool': 'Apri la particella in geopool',
    ...
    'landing.subtitle': 'similoo trova edifici comparabili a quello di questo indirizzo - stesso comune e stessa zona, costruzione recente - e li mostra come cubi LOD 2.5 sulla mappa più un\'ispezione 3D dettagliata su richiesta.',
    ...
    'legend.same_zone': 'Particelle dello stesso tipo di zona comunale',
    'legend.comparable': 'Edifici comparabili',

    'detail.close': 'Chiudi vista 3D dettagliata',
    'detail.color_elevation': 'Quota',
    'detail.color_classification': 'Classificazione',
    'detail.color_intensity': 'Intensità',
    'detail.preparing': 'Preparazione della nuvola di punti… {percent}%',
    ...
    'help.intro':
      'Quando cerchi un indirizzo, similoo cerca edifici realmente paragonabili a quello sulla tua particella - stesso comune, stessa zona di pianificazione, età simile, densità simile - e poi li classifica in base a quanto corrispondono. Ecco esattamente come funziona.',
    ...
    'help.filter_year_title': 'Età dell\'edificio',
    'help.filter_year_body':
      'Contano solo gli edifici più recenti dell\'età massima - 10 anni per impostazione predefinita. Il cursore nella barra laterale si sposta a passi di un anno, da 1 a 10 anni, così da seguire una modifica recente del piano delle zone o del diritto edilizio: impostalo sugli anni trascorsi dall\'entrata in vigore della norma e restano solo gli edifici completati sotto di essa. Restringendolo emergono comparabili meno numerosi e più recenti. Nelle zone in cui si è costruito poco di recente restano pochi risultati o nessuno: per questo oltre i 10 anni il cursore si allarga in altri tre scatti - 15 anni, 20 anni e «Qualsiasi età», che elimina il limite sull\'anno di costruzione e confronta con tutta la zona.',
    ...
    'help.step3_note':
      'Più la superficie della particella, il ratioV e l\'età di un candidato sono vicini al riferimento, più alta è la sua corrispondenza. Le schede sono ordinate per similarità per impostazione predefinita, ma puoi riordinarle per ratioV, superficie, anno, volume realizzabile o sfruttamento, sei schede per pagina.',
